			...
			<div class="handle-box">
				<el-form :inline="true" :model="query" class="demo-form-inline">
                    ...
                    <el-form-item>
                        ...
                        <el-button type="primary" :icon="Plus" @click="handleAdd()">新建创作者</el-button>
                    </el-form-item>
                </el-form>
			</div>
			<el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                <el-table-column prop="pic" label="创作者logo"> 
					 <template #default="{row}">
						<el-image
							class="table-td-thumb"
							:src="row.logUrl"
							:z-index="10"
							:preview-src-list="[row.logUrl]"
							preview-teleported
						>
						</el-image>
					</template>
				</el-table-column>
				<el-table-column prop="name" label="创作者"></el-table-column>
...
const getCreatorAll =async () => {
	const {data} =await proxy.API.getCreatorAll();
	creatorList.value = data.result;
};
