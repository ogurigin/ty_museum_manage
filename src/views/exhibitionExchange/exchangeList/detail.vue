<template>
  ...
  <div class="videoInput" style="margin-top: 0;">
    <div class="videoInp">
      <div class="text"><span class="require">*</span>展览数量</div>
      <el-select v-model="formInline.number" placeholder="请选择">
        <el-option v-for="item in ZLNumoptions" :key="item.value" :label="item.label" :value="item.value">
        </el-option>
      </el-select>
    </div>
  </div>
  <div class="videoInput">
    <div class="videoInp" style="align-items: flex-start; width: 960px">
      <div class="text"><span class="require">*</span>展览简介</div>
      <div class="editor">
